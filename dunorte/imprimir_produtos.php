						...
						<div class="portlet light">
							<div class='portlet-title'>
								<div class="caption">
									...
									<span class="font-<?php echo $core->primeira_cor;?>"><?php echo lang('ESTOQUE_LISTAR');?></span>
								</div>
											...
											<table class="table table-bordered table-striped table-advance table-condensed">
												...
												?>
													<tr>
														...
														<td><?php echo $exrow->familia;?></td>
														<td><?php echo $exrow->fabricante;?></td>
														<td><span class="bold theme-font"><?php echo decimal($total);?></span></td>
													</tr>
												<?php 	endforeach;?>
												<?php unset($exrow);
													  endif;?>
