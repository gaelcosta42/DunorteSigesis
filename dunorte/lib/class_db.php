<?php
  ...
  class Database
  {
      ...
      protected $error_desc = "Nao determinado.";
      ...
      /**
       * Database::insert_print()
       * Insert query with an array
       * @param mixed $table
       * @param mixed $data
       * @return id of inserted record, false if error
       */
      public function insert_print($table = null, $data)
      {
		  if ($table === null or empty($data) or !is_array($data)) {
		  $this->error("Invalid array for table: <b>".$table."</b>.");
		  return false;
       ...
       * @return query_id
       */
      public function update_print($table = null, $data, $where = '1')
      {
		  if ($table === null or empty($data) or !is_array($data)) {
		  $this->error("Invalid array for table: <b>" . $table . "</b>.");
		  return false;
	 ...
	 /**
      ...
      public function insertImportFornecedoresClientes($table = null, $data)
      {
		  if ($table === null or empty($data) or !is_array($data)) {
		  $this->error("Invalid array for table: <b>".$table."</b>.");
		  return false;
