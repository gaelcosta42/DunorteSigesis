<?php
  ...
  define("_VALID_PHP", true);
	...
	$dataini = (get('dataini')) ? get('dataini') : date('d/m/Y', strtotime('-30 days')); 
	$datafim = (get('datafim')) ? get('datafim') : date('d/m/Y', strtotime('30 days')); 
	$nome = ($id_empresa) ? getValue("nome", "empresa", "id = ".$id_empresa) : "TODAS";
										...
										<td>
											<table class="table table-bordered table-striped table-condensed" >
												<thead>
													...
													<tbody>
													<?php 	
														$retorno_row = $despesa->getDespesas($id_empresa, $dataini, $datafim, $id_banco, $id_conta, $id_cadastro, $valor);
														$total = 0;
														if($retorno_row):
