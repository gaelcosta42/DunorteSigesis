...
class TCPDF {
	...
	/**
	 * Define o tipo de cabeçalho.
	 * @protected
	 */
	protected $cEmpresa = false;
	...
	/**
	 * String to pring on page header linha 1, linha 2
	 * @protected
	 */
	protected $header_line1a = '';
	protected $header_line1b = '';
	protected $header_line1c = '';
	protected $header_line2a = '';
	protected $header_line2b = '';
	protected $header_line2c = '';
	 ...
	 * @public
	 */
	public function setHeaderEmpresa($ln='', $lw=0, $line1a='', $line1b='', $line1c='', $line2a='', $line2b='', $line2c='') {
		$this->cEmpresa	= true;
		$this->header_logo = $ln;
		$this->header_logo_width = $lw;
		$this->header_line1a = $line1a;
		$this->header_line1b = $line1b;
		$this->header_line1c = $line1c;
		$this->header_line2a = $line2a;
		$this->header_line2b = $line2b;
		$this->header_line2c = $line2c;
	}
	...
	public function getHeaderData() {
		...
		$ret['line1a'] = $this->header_line1a;
		$ret['line1b'] = $this->header_line1b;
		$ret['line1c'] = $this->header_line1c;
		$ret['line2a'] = $this->header_line2a;
		$ret['line2b'] = $this->header_line2b;
		$ret['line2c'] = $this->header_line2c;
		return $ret;
	}
	...
	public function Header() {
		if ($this->header_xobjid === false) {
			...
			// header title
			if($this->cEmpresa) {
				$this->SetFont($headerfont[0], '', $headerfont[2]-3);
				$this->SetXY($header_x,5);
				$this->Cell(0, 5, substr($headerdata['line1a'], 0, 50), 0, 0, 'L');
				$this->SetXY($header_x,9);
				$this->Cell(0, 5, substr($headerdata['line1b'], 0, 50), 0, 0, 'L');
				$this->SetXY($header_x,13);
				$this->Cell(0, 5, substr($headerdata['line1c'], 0, 50), 0, 0, 'L');
				$this->SetXY($header_x+70,5);
				$this->Cell(65, 5, substr($headerdata['line2a'], 0, 45), 0, 0, 'L');
				$this->SetXY($header_x+70,9);
				$this->Cell(65, 5, substr($headerdata['line2b'], 0, 45), 0, 0, 'L');
				$this->SetXY($header_x+70,13);
				$this->Cell(65, 5, substr($headerdata['line2c'], 0, 45), 0, 0, 'L');
			} else {
	...
	public function Footer() {
		$this->SetY(-15);
		$this->Cell(0,10,('SIGESIS® - Sistemas de Gestão - Impressão: ').date('d/m/Y H:i:s'),'T',0,'L');
		$this->Cell(0,10,'Página '.$this->PageNo().'/'.$this->getAliasNbPages(),0,0,'R');
	}
