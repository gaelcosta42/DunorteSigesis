var FormFileUpload = function () {
    ...
    return {
		...
		plupload.addI18n({
			'Select files' : 'Selecione o arquivo da logomarca',
			'Add files to the upload queue and click the start button.' : 'Adicione o arquivo de logo para fila de upload e clique no botão Iniciar',
			...
			'Drag files here.' : 'Arraste solte o arquivo da logomarca aqui (Somente arquivo PNG de tamanho 265x85px)'
		});
