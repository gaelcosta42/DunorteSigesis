var FormFileUpload = function () {
    ...
    return {
		...
		plupload.addI18n({
			'Select files' : 'Selecione o arquivo do Certificado Digital',
			'Add files to the upload queue and click the start button.' : 'Adicione o arquivo do Certificado para fila de upload e clique no botão Iniciar',
			'Filename' : 'Nome do arquivo',
			'Status' : 'Status',
			'Size' : 'Tamanho',
			'Add files' : 'Adicionar arquivo',
			'Start upload':'Salvar Arquivo',
			'Stop current upload' : 'Parar processo atual',
			'Start uploading queue' : 'Iniciar processo de upload',
			'Drag files here.' : 'Arraste solte o arquivo do Certificado Digital aqui (Geralmente um arquivo com extensão .crt)'
		});
