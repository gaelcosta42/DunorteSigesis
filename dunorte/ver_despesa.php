<?php
  ...
  define("_VALID_PHP", true);
	...
	$detalhes_row = $despesa->getDetalhesDespesa($id_despesa);
						...
						<div class="portlet light">
							<div class='portlet-title'>
								<div class="caption">
									...
									<span class="font-<?php echo $core->primeira_cor;?>"><?php echo lang('DESPESA').": ".$id_despesa;?></span>
								</div>
									...
									<tr>
										<td>
											<table class="table table-bordered table-advance table-condensed">
												<thead>
													<tr>
														<th colspan="2"><?php echo lang('DESPESA');?></th>
													</tr>
												</thead>
												<tbody>
													<tr>
													...
													<tr>
														...
														<td><?php echo ($detalhes_row->pago) ? "<label class='label label-sm bg-green'>SIM</label>" : "<label class='label label-sm bg-red'>NAO</label>";?></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><?php echo ($detalhes_row->pago) ? moeda($detalhes_row->valor_pago) : "-";?></td>
													</tr>
													<?php if($detalhes_row->valor_pago > $detalhes_row->valor): ?>
													<tr>
														<th><?php echo lang('JUROS');?>:&nbsp;&nbsp;</th>
														<td><?php echo moeda($detalhes_row->valor_pago - $detalhes_row->valor);?></td>
													</tr>
													<?php endif; ?>
													<tr>
													...
													<tr>
														...
														<td><?php echo exibedata($detalhes_row->data_vencimento);?></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><?php echo $detalhes_row->nro_documento;?></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><?php echo exibedata($detalhes_row->data);?></td>
													</tr>
												<tbody>
											</table>
										</td>
