...
{
	if($this->cabecalho) {
	$this->Image('./assets/img/logo_carta.jpg',1,1,-300);
	}
}
...
function Footer()
{
	if($this->rodape) {
		...
		// Page number
		$this->Cell(0,10,('SIGESIS - Sistemas - Impressão: ').date('d/m/Y H:i:s'),0,0,'L');
...
// Sub Titulo
function subtitulo($texto1 = ' ', $texto2 = ' ', $inicio = 18)
{
