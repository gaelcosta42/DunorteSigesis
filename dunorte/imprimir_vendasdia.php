						...
						<div class="portlet light">
							<div class='portlet-title'>
								<div class="caption">
									...
									<span class="font-<?php echo $core->primeira_cor;?>"><?php echo lang('VENDAS_DO_DIA')." - ".$data;?></span>
								</div>
													...
													<?php 	
														...
														if($retorno_row):
															foreach ($retorno_row as $exrow):
																...
																$total += ($exrow->inativo) ? 0 : $exrow->valor_pago;
													?>
														<tr>
															...
															<td><span class="bold theme-font valor_total"><?php echo moedap($exrow->valor_pago);?></span></td>
