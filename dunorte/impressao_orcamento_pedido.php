...
class Impressao_PDF extends TCPDF {
	...
	public function Titulo($titulo) {
		$this->titulo = $titulo;		
		$this->SetCreator('SIGESIS - Sistemas de Gestao');
		$this->SetAuthor('Vale Telecom');
		$this->SetTitle($titulo);
		$this->SetKeywords('sige, sigesis, sistemas gestao, telecom');
	}
	...
	public function HeaderPDF() {
		...
		$this->SetHeaderData($this->imagem_logo, 50, $this->titulo, $this->subtitulo);
	}
