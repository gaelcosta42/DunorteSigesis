...
<!--
 ...
 -->
		...
		<div id="instr_content">
			...
			<h2><?php echo lang('BOLETOS_INSTRUCOES');?></h2>
			<ol>
			<?php echo lang('BOLETOS_TEXTO');?>
			</ol>
		</div>	<!-- id="instr_content" -->
	</div>	<!-- id="instructions" -->
	...
	<div id="boleto">
		<div class="cut">
			<p class="cut_corte"><?php echo lang('BOLETOS_CORTE');?></p>
			<p class="cut_recibo"><?php echo "Recibo do pagador"; ?></p>
		</div>
		...
		<tbody>
		<tr>
			<td width=150><img src="assets/img_boleto/logocaixa.jpg"></td>
			<td width=50>
		...
		<tbody>
		<tr class="titulos">
			<td class="cedente"><?php echo lang('BOLETOS_CEDENTE');?></td>
			<td class="ag_cod_cedente"><?php echo lang('BOLETOS_AGENCIA');?></td>
			<td class="especie"><?php echo lang('BOLETOS_ESPECIE');?></td>
			<td class="qtd"><?php echo lang('QUANTIDADE');?></td>
			<td class="nosso_numero"><?php echo lang('BOLETOS_NOSSONUMERO');?></td>
		</tr>

		<tr class="campos">
			<td class="cedente"><?php echo $dadosboleto["cedente"].'<br>'.$dadosboleto["endereco"]; ?>&nbsp;</td>
		...
		<div class="cut">
			<p class="cut_corte"><?php echo lang('BOLETOS_CORTE');?></p>
			<p class="cut_recibo"><?php echo "Recibo do sacado"; ?></p>
		</div>
		...
		<tr class="campos">
			<td class="local_pagto">EM TODA A REDE BANC&Aacute;RIA E SEUS CORRESPONDENTES AT&Eacute; O VALOR LIMITE</td>
		...
		<tr class="campos">
			<td class="cedente2"><?php echo $dadosboleto["cedente"].'<br>'.$dadosboleto["endereco"]; ?></td>
		...
		<tr><td class="last_line" rowspan="6">
			...
			<tr class="campos">
				<td class="instrucoes" rowspan="5">
					...
					<p style="font-size:8px!important;"><?php echo $dadosboleto["instrucoes4"]; ?></p>
				</td>
			</tr>
			</tbody>
			</table>
		...
		<tr class="campos">
			...
			<td class="cod_baixa">C&oacute;d. baixa <?php echo $dadosboleto["nosso_numero"]; ?></td>
		</tr>
		</tbody>
		</table>		
		...
		<div class="barcode">
			<p><?php echo $boleto->fbarcode($dadosboleto["codigo_barras"]); ?></p>
		</div>
