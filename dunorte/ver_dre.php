<?php
  ...
  define("_VALID_PHP", true);
	...
	$mes = get('mes');
	$ano = get('ano');
	$conta = getValue("conta", "conta", "id = ".$id_conta);	
?>
<!DOCTYPE html>
					...
					<div class="col-md-12">			
						<div class="portlet light">
							<div class='portlet-title'>
								<div class="caption">							
									<span class="font-<?php echo $core->primeira_cor;?>"><?php echo lang('FINANCEIRO_DRE')." - ".$conta." - ".$mes."/".$ano;?></span>
								</div>
										...
										<td>
											<table class="table table-bordered table-striped table-advance table-condensed">
												<thead>
													...
													<tbody>
													<?php 	
														$retorno_row = $despesa->getListaDespesasDRE($id_conta, $mes, $ano, $id_empresa);
														$total = 0;
														if($retorno_row):
														foreach ($retorno_row as $exrow):
															...
															if($exrow->banco) {
																$banco_caixa = $exrow->banco;
															} elseif($exrow->id_caixa){
																$banco_caixa = "CAIXA: ".$exrow->id_caixa;
															}
