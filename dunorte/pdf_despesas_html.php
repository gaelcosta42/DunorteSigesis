...
<table class="tabela">
	...
	<tbody>
		...
		?>
			<tr>
				<td width="80px"><?php echo exibedata($exrow->data_vencimento);?></td>
				<td width="130px"><?php echo substr($exrow->empresa,0,15);?></td>
				<td width="90px"><?php echo substr($exrow->conta,0,10);?></td>
				<td width="168px"><?php echo substr($exrow->cadastro,0,25);?></td>
				<td width="90px"><?php echo substr($exrow->descricao,0,10);?></td>
