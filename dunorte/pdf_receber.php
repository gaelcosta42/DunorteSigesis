<?php
  ...
  define("_VALID_PHP", true);
	...
	$ordem_cliente = (get('ordem_cliente')==1) ? get('ordem_cliente') : 0; 
	$filtro = (get('filtro')) ? get('filtro') : 0; 
	
	
	$retorno_row = $faturamento->getReceitasReceber($dataini, $datafim, $id_banco, $id_empresa, $ordem_cliente, $filtro);
	$pdf = new Impressao_PDF();
	$pdf->Titulo(lang('FINANCEIRO_RECEITAS'));
	...
	ob_start();
		require(BASEPATH . 'pdf_receber_html.php');
