...
<head>
<meta charset="utf-8"/>
<title><?php echo $core->empresa." ".lang('BOLETO_TITULO');?></title>
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta content="width=device-width, initial-scale=1.0" name="viewport"/>
<meta http-equiv="Content-type" content="text/html; charset=utf-8">
<meta content="Sistemas Divulgação Online" name="description"/>
<meta content="Geandro Bessa" name="author"/>
<!-- Favicons -->
...
$codigobanco = lang('BOLETOS_SICOOB_CODIGO'); // Num da agencia, sem digito
$agencia = lang('BOLETOS_SICOOB_AGENCIA'); // Num da agencia, sem digito
$conta = lang('BOLETOS_SICOOB_CONTA'); // Num da conta, sem digito
$convenio = lang('BOLETOS_SICOOB_CONVENIO'); //Número do convênio indicado no frontend
...
if($retorno_row) {
	...
	$dadosboleto["numero_documento"] = $exrow->numero_nota;	// Num do pedido ou do documento
	...
	$dadosboleto["cpf_cnpj"] = lang('BOLETOS_SICOOB_CNPJ_EMPRESA');
	$dadosboleto["endereco"] = lang('BOLETOS_SICOOB_END_EMPRESA');
	$dadosboleto["cidade_uf"] = lang('BOLETOS_SICOOB_CIDADE_EMPRESA');
	$dadosboleto["cedente"] = lang('BOLETOS_SICOOB_RAZAO_EMPRESA');
	...
	include("../boleto_sicoob_layout.php");
	$quebra = true;
	}
}
?>
